...
MU_BY_TYPE = {
    "Гамма": {
        "Свинец": 1.20, "Сталь": 0.80, "Бетон": 0.35, "Вода": 0.30, "Стекло/акрил": 0.15, "Алюминий": 0.55
    },
    "Бета": {
        "Стекло/акрил": 1.10, "Вода": 0.80, "Бетон": 0.40, "Сталь": 0.20, "Свинец": 0.05, "Алюминий": 0.35
    },
    "Альфа": {
        "Свинец": 25.0, "Сталь": 20.0, "Бетон": 15.0, "Вода": 12.0, "Стекло/акрил": 18.0, "Алюминий": 19.0
    },
    "Нейтроны": {
        "Вода": 1.10, "Бетон": 0.90, "Стекло/акрил": 0.30, "Сталь": 0.20, "Свинец": 0.10, "Алюминий": 0.25
    },
}
...
DANGEROUS_COMBINATIONS = [
    {
        "materials": {"Свинец", "Вода"},
        "messages": {
            "RU": "Свинец и вода требуют строгой изоляции, чтобы избежать загрязнения и коррозии.",
            "EN": "Lead and water must be isolated to prevent corrosion and contamination.",
            "ZH": "铅与水必须隔离，以免产生腐蚀和污染。",
        },
    },
    {
        "materials": {"Свинец", "Алюминий"},
        "messages": {
            "RU": "Свинец и алюминий при контакте могут вызывать гальваническую коррозию и токсичную пыль.",
            "EN": "Lead and aluminium together may cause galvanic corrosion and toxic dust.",
            "ZH": "铅与铝接触可能引发电化学腐蚀并产生有毒粉尘。",
        },
    },
    {
        "materials": {"Сталь", "Вода"},
        "messages": {
            "RU": "Сталь и вода без защиты вызывают коррозию и потерю экранирующих свойств.",
            "EN": "Steel in contact with water corrodes quickly and loses shielding efficiency.",
            "ZH": "钢材与水接触会迅速腐蚀并降低屏蔽效果。",
        },
    },
]
